...
export default class {
  constructor (opts) {
    ...
    const paramFilters = pick(opts.params, ['organization', 'category', 'decade', 'country', 'access'])
    const attributeFilters = pick(opts.el.data(), ['organization', 'category', 'decade', 'country', 'access'])
